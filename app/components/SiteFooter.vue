  ...
  <footer id="footer">
    ...
    <n-flex :size="4" class="text" align="center" vertical>
      ...
      <n-p depth="3">
        ...
        <n-text depth="3" @click="jumpLink(linkData.home)"> Joker2Yue </n-text>
        <n-text
          v-if="siteIcp"
          depth="3"
...
const linkData = {
  github: "https://github.com/Joker2Yue/site-status",
  home: "https://www.joker2yue.com",
  email: "mailto:me@joker2yue.com",
};
</script>
